...
<asp:Content ID="Content2" ContentPlaceHolderID="ViewPortContent" runat="server">
    ...
    <div style="width: 660px;">
        ...
        <p class="pageBodyPar1">
         ...
         <h4 class="paragraphHeaderH4">JPE Blood Donation.</h4>
        <img src="images/PugetSoundBloodCenter.jpg"  style="height: 150; width: 200; margin-right: 10px; float:left;"><br />
        <p class="pageBody">
            
            Employees at Jet Parts Engineering donate blood every 3 months with the help of the <a href="http://www.psbc.org/programs/index.htm">Puget Sound Blood 
            Center</a> . We know each donation can save up to 3 lives and are eager to  ensure this precious resource is available 
            for ill and injured people in our community. 
            <br>
            
        
        </p>
        
        <h4 class="paragraphHeaderH4">Big Climb Fund Raising.</h4>
        <img src="images/BigClimb14.jpg"  style="height: 50; width: 150; margin-right: 5px; float:left;"><br />
        <p class="pageBody">
            
            
            For 3 years in a row, Jet Parts Engineering employees have made the <a href="http://www.llswa.org/site/PageNavigator/SeattleBigClimb/Home.html"> Big Climb</a> to raise money 
            for the Leukemia &amp; Lymphoma Society (LLS). In support of the LLS mission: To cure Leukemia, 
            Lymphoma, Hodgkin's Disease and Myeloma, JPE employees contributed over $2,500 and climbed 69 
            stories of the Seattle Skyscraper, the Columbia Center Tower. 
            <br>
            
            Pictured on the left, the JPE team poses just before they set off to tackle the 69 flights of stairs.  
