...
public class GenUtils
{
    ...
    public static DataTable FindParts(string strWhereString, string TopCount)
    {
        ...
        queryString += " AND (P.STC_AUTO_KEY = 2 OR P.STC_AUTO_KEY = 3 OR P.STC_AUTO_KEY = 4 OR P.STC_AUTO_KEY = 6 OR   P.STC_AUTO_KEY = 10  OR P.STC_AUTO_KEY = 11 OR P.STC_AUTO_KEY = 12 OR P.STC_AUTO_KEY = 20 OR P.STC_AUTO_KEY = 26  OR P.STC_AUTO_KEY = 29  OR P.STC_AUTO_KEY = 30  ) ";
