<%@ Page Title="" Language="C#" MasterPageFile="~/Code/Site.Master" AutoEventWireup="true" CodeBehind="hauppauge.aspx.cs" Inherits="JetParts.Web.Com.hauppauge" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ViewPortContent" runat="server">
    <jpe:PageHeader ID="pageHeader" MouseOutImage="images/banner_hauppauge_bw.png" MouseOverImage="images/banner_hauppauge_color.png"
        Alt="Jet Parts Engineering Hauppauge, New York Office" runat="server" />
