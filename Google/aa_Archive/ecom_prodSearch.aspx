<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ecom_prodSearch.aspx.cs" Inherits="ecom_prodSearch" Theme="eCommerceTheme" EnableEventValidation="false"  
...
<head runat="server">
    ...
    <title>Jet Parts Engineering: Product Search</title>
...
<td style="text-align:right; margin-right:5px auto;vertical-align:top; font-family:Verdana;font-size:9px;font-weight:600;color:#0B2B75;">
 <% 
  ...
  <input type='text' name='txtQTY_Search-SingleMatch_test1#213564' class='SBtxtQtyCntrl' id='txtQTY_Search-SingleMatch_test1#213564' maxlength='5' onkeypress='return checkIt(event)' Onblur="javascript: return alignQtyBoxes('txtQTY_Search-SingleMatch_test1#213564');" value='0' onFocus ='javascript:this.select();'>
  
  

  <input type='text' name='txtQTY_Search-SingleMatch_test1#4646487' class='SBtxtQtyCntrl' id='txtQTY_Search-SingleMatch_test1#4646487' maxlength='5' onkeypress='return checkIt(event)' Onblur="javascript: return alignQtyBoxes('txtQTY_Search-SingleMatch_test1#4646487');" value='0' onFocus ='javascript:this.select();'>
  
  
  
  <input type='text' name='txtQTY_Search-SingleMatch_test1#123154564' class='SBtxtQtyCntrl' id='txtQTY_Search-SingleMatch_test1#123154564' maxlength='5' onkeypress='return checkIt(event)' Onblur="javascript: return alignQtyBoxes('txtQTY_Search-SingleMatch_test1#123154564');" value='0' onFocus ='javascript:this.select();'>
  --%>
